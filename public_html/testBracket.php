...
function getVote(int){
  ...
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("testBracket").innerHTML=this.responseText;
    }
  }
  xmlhttp.open("GET","testBracket.php?song="+int,true);
  xmlhttp.send();
}
</script>
                                      ...
                                      <div class="caption">
                                          <h5 style="padding-right:2em; color:#FFFFFF">'.$band[$count].'  ~ '.$track[$count].'</h5>
                                            <p>
                                                ...
                                                <form>
                                                  <input type="button" value="Vote" class="btn btn-primary" id="'.$count.'" onclick="getVote(this.id)">
                                                </form>
                                            </p>
                                      </div>
                                  </div>
