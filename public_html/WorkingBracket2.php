...
<body>
<!--title of the page-->
  <h1 style="text-align:center"> Summer Jams Contest <h1>
  ...
  <div class="row">
    <div class="col-md-6">
        <?php
          ...
          $band = array("cloonyw21","deepgraysea","jackjohnsonmusic","kygo","diplo","678carti","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21","cloonyw21");

          // array for track names
          $track = array("Mystery","aurora", "posters", "intro", "go","magnolia-1","Mystery","Mystery","Mystery","Mystery","Mystery","Mystery","Mystery","Mystery","Mystery","Mystery");
              ...
              echo    '<table class="table-condensed" style="width:100%">
                          <tr>
                              <td class="col-md-5"><div class="input-group" style="min-width:50em">
                                  <div class="thumbnail" style="background-image: url(imgs/Summer.png); background-size:cover">
                                      <div class="caption">
